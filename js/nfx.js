...
window.NFX = (function () {
  ...
  /* ============================================================
     ...
     turn     ：转板对镜头——「第 1095 天。她今天也来了。」占满画面
     close    ：关闭终端——窗口缩小熄灭，残光 4% 后全暗
     每镜引擎自定时长；t=该镜经过秒。谢幕曲续播由引擎负责（本模块不发声）。
     ============================================================ */
  var TURN_LINE = '第 1095 天。她今天也来了。';   // 批次23 B23（09-23 用户手打覆盖·审读版 W-176 斜体行）：refrain 换「她」仅尾声这一处（D50 裁定①）；与 META.endings.truth.epilogue turn 行括注双源合一、必须同字
